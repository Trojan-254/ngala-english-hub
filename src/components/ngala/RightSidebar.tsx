...
const leaders = [
  { rank: 1, name: "Amina Said",   xp: 1840, init: "AS" },
  { rank: 2, name: "Brian Kaluma", xp: 1620, init: "BK" },
  { rank: 3, name: "John Otieno",  xp: 1485, init: "JO", me: true },
  { rank: 4, name: "Fatma Juma",   xp: 1320, init: "FJ" },
  { rank: 5, name: "Daniel Mwangi",xp: 1190, init: "DM" },
];
